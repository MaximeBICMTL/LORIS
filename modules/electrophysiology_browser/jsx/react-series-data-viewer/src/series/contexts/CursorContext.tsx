...
export const CursorProvider: FunctionComponent<{
...
function getChannelsAtCursor(
  ...
  if (cursorPosition === null || !viewerRef?.current?.container) {
    return [];
  }

  const viewerElement = viewerRef.current.container as Element;
