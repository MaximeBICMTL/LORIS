...
final class ReverseProxyTest extends TestCase
{
    ...
    /**
     * Ensure configured upstream errors do not expose their entity contents.
     *
     * @return void
     */
    public function testHidesUpstreamErrorBody(): void
    {
        ...
        $proxy = new \LORIS\imaging_gateway\ReverseProxy(
            $client,
            'http://127.0.0.1:8000',
            5.0,
            new NullLogger(),
        ...
        $response = $proxy->forward(
            new ServerRequest('GET', 'https://loris.example/imaging_gateway/x'),
            new Uri('/x'),
            'signed-token',
        );
        ...
        $this->assertSame('upstream-id', $response->getHeaderLine('X-Request-ID'));
    }
